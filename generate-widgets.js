...
<svg width="600" height="400" viewBox="0 0 600 400" fill="none" xmlns="http://www.w3.org/2000/svg">
  ...
  <g transform="translate(25, 55)">
    ...
    <text x="195" y="40" class="value" text-anchor="end">${totalContributionsPastYear}</text>
    ...
    <text x="195" y="86" class="value" text-anchor="end">${publicReposCount}</text>
    ...
    <text x="195" y="109" class="value" text-anchor="end">${totalReleases}</text>
