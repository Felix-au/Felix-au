...
<svg width="600" height="400" viewBox="0 0 600 400" fill="none" xmlns="http://www.w3.org/2000/svg">
  ...
  <!-- Centered Title -->
  <text x="300" y="35" class="title" text-anchor="middle">GitHub Stats</text>
  
  <!-- COLUMN 1 -->
  <g transform="translate(25, 55)">
    <!-- Commits 365 Days -->
    <svg x="0" y="10" width="14" height="14" viewBox="0 0 16 16" class="icon"><path d="M10.5 7.75a2.5 2.5 0 1 1-5 0 2.5 2.5 0 0 1 5 0Zm1.5 0a4 4 0 1 0-8 0 4 4 0 0 0 8 0ZM8 0a.75.75 0 0 1 .75.75v1.5a.75.75 0 0 1-1.5 0v-1.5A.75.75 0 0 1 8 0ZM8 13a.75.75 0 0 1 .75.75v1.5a.75.75 0 0 1-1.5 0v-1.5A.75.75 0 0 1 8 13ZM3 8a.75.75 0 0 1-.75.75h-1.5a.75.75 0 0 1 0-1.5h1.5A.75.75 0 0 1 3 8Zm11.5.75a.75.75 0 0 0 0-1.5h-1.5a.75.75 0 0 0 0 1.5h1.5Z"/></svg>
    <text x="22" y="22" class="label">Commits (365 days):</text>
    <text x="195" y="22" class="value" text-anchor="end">${commits365Days}</text>
    
    <!-- Total Stars -->
    <svg x="0" y="45" width="14" height="14" viewBox="0 0 16 16" class="icon"><path d="M8 .25a.75.75 0 0 1 .673.418l1.882 3.815 4.21.612a.75.75 0 0 1 .416 1.279l-3.046 2.97.719 4.192a.751.751 0 0 1-1.088.791L8 12.347l-3.766 1.98a.75.75 0 0 1-1.088-.79l.72-4.194L.818 6.374a.75.75 0 0 1 .416-1.28l4.21-.611L7.327.668A.75.75 0 0 1 8 .25Z"/></svg>
    <text x="22" y="57" class="label">Total Stars:</text>
    <text x="195" y="57" class="value" text-anchor="end">${stars}</text>
    
    <!-- Total Forks -->
    <svg x="0" y="80" width="14" height="14" viewBox="0 0 16 16" class="icon"><path d="M5 3.25a.75.75 0 1 1-1.5 0 .75.75 0 0 1 1.5 0Zm0 2.122a2.25 2.25 0 1 0-1.5 0v.878A2.25 2.25 0 0 0 5.75 8.5h4.5A2.25 2.25 0 0 0 12.5 6.25v-.878a2.25 2.25 0 1 0-1.5 0v.878a.75.75 0 0 1-.75.75h-4.5A.75.75 0 0 1 5 6.25v-.878Zm7.5-2.122a.75.75 0 1 1-1.5 0 .75.75 0 0 1 1.5 0ZM4.25 12a.75.75 0 1 0 0-1.5.75.75 0 0 0 0 1.5Zm0 1.5a2.25 2.25 0 1 1 0-4.5 2.25 2.25 0 0 1 0 4.5Z"/></svg>
    <text x="22" y="92" class="label">Total Forks:</text>
    <text x="195" y="92" class="value" text-anchor="end">${forks}</text>
    
    <!-- Releases -->
    <svg x="0" y="115" width="14" height="14" viewBox="0 0 16 16" class="icon"><path d="M2.5 0A2.5 2.5 0 0 0 0 2.5v11A2.5 2.5 0 0 0 2.5 16h11a2.5 2.5 0 0 0 2.5-2.5v-11A2.5 2.5 0 0 0 13.5 0h-11Zm0 1.5h11a1 1 0 0 1 1 1v6.75l-4-4-3 3-2-2-3 3v-7.75a1 1 0 0 1 1-1Z"/></svg>
    <text x="22" y="127" class="label">Releases:</text>
    <text x="195" y="127" class="value" text-anchor="end">${totalReleases}</text>
  </g>
  ...
  <g transform="translate(380, 55)">
    <!-- Total Contributions -->
    <svg x="0" y="10" width="14" height="14" viewBox="0 0 16 16" class="icon"><path d="M8 0a8 8 0 1 1 0 16A8 8 0 0 1 8 0ZM1.5 8a6.5 6.5 0 1 0 13 0 6.5 6.5 0 0 0-13 0Z"/></svg>
    <text x="22" y="22" class="label">Contributions (365 days):</text>
    <text x="200" y="22" class="value" text-anchor="end">${totalContributionsPastYear}</text>
    
    <!-- Total Watchers -->
    <svg x="0" y="45" width="14" height="14" viewBox="0 0 16 16" class="icon"><path d="M8 2c1.981 0 3.671.992 4.933 2.078 1.27 1.091 2.267 2.445 2.872 3.593a.75.75 0 0 1-.001.658c-.605 1.147-1.602 2.502-2.872 3.593C11.671 13.008 9.981 14 8 14c-1.981 0-3.671-.992-4.933-2.078C1.797 10.83 .8 9.476.196 8.329a.75.75 0 0 1 .001-.658c.605-1.147 1.602-2.502 2.872-3.593C4.329 2.992 6.019 2 8 2ZM2.052 8c.552 1.01 1.436 2.222 2.548 3.18C5.7 12.138 7.006 12.5 8 12.5c.994 0 2.3-.362 3.4-1.32 1.112-.958 1.996-2.17 2.548-3.18-.552-1.01-1.436-2.222-2.548-3.18C10.3 3.862 8.994 3.5 8 3.5c-.994 0-2.3.362-3.4 1.32-1.112.958-1.996 2.17-2.548 3.18ZM8 10a2 2 0 1 1-.001-3.999A2 2 0 0 1 8 10Z"/></svg>
    <text x="22" y="57" class="label">Total Watchers:</text>
    <text x="200" y="57" class="value" text-anchor="end">${watchers}</text>
    
    <!-- Repositories -->
    <svg x="0" y="80" width="14" height="14" viewBox="0 0 16 16" class="icon"><path d="M2 2.5A2.5 2.5 0 0 1 4.5 0h8.75a.75.75 0 0 1 .75.75v12.5a.75.75 0 0 1-.75.75h-2.5a.75.75 0 1 1 0-1.5h1.75v-2h-8a1 1 0 0 0-.714 1.7.75.75 0 0 1-1.072 1.05A2.495 2.495 0 0 1 2 11.5v-9Zm10.5-1h-8a1 1 0 0 0-1 1v6.708A2.486 2.486 0 0 1 4.5 9h8v-7.5Z"/></svg>
    <text x="22" y="92" class="label">Repositories:</text>
    <text x="200" y="92" class="value" text-anchor="end">${publicReposCount}</text>
    
    <!-- Downloads -->
    <svg x="0" y="115" width="14" height="14" viewBox="0 0 16 16" class="icon"><path d="M2.75 14A.75.75 0 0 1 3.5 13.25h9a.75.75 0 0 1 0 1.5h-9A.75.75 0 0 1 2.75 14Zm5.25-10.25V9.19l2.22-2.22a.75.75 0 1 1 1.06 1.06l-3.5 3.5a.75.75 0 0 1-1.06 0l-3.5-3.5a.75.75 0 1 1 1.06-1.06L7 9.19V3.75a.75.75 0 0 1 1.5 0Z"/></svg>
    <text x="22" y="127" class="label">Downloads:</text>
    <text x="200" y="127" class="value" text-anchor="end">${totalDownloads}</text>
  </g>
  
  <!-- Divider -->
  <line x1="25" y1="200" x2="575" y2="200" class="divider" />
  ...
  <g transform="translate(0, 200)">
    ...
    <!-- Longest Streak -->
    <text x="440" y="28" class="streak-title" text-anchor="middle">🏆 Longest Streak: <tspan class="streak-val">${longestStreak} Days</tspan> <tspan class="streak-range">(${longestStreakRange})</tspan></text>
  </g>
  
  <!-- Divider -->
  <line x1="25" y1="250" x2="575" y2="250" class="divider" />
