...
<svg width="600" height="400" viewBox="0 0 600 400" fill="none" xmlns="http://www.w3.org/2000/svg">
  <style>
    ...
    .streak-title { font: bold 15px 'Segoe UI', Ubuntu, sans-serif; fill: #d8dee9; }
    .streak-val { font: bold 15px 'Segoe UI', Ubuntu, sans-serif; fill: #88c0d0; }
    .streak-range { font: 12px 'Segoe UI', Ubuntu, sans-serif; fill: #e5e9f0; opacity: 0.85; }
